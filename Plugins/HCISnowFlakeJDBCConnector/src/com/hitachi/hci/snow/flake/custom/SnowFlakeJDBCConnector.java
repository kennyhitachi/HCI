package com.hitachi.hci.snow.flake.custom;
...
/**
 * JDBC Connector Plugin for SnowFlake Warehouse.
 *
 */
public class SnowFlakeJDBCConnector extends BaseJdbcConnectorPlugin {

    private static final String PLUGIN_NAME = "SnowFlakeWarehouse";
    private static final String DISPLAY_NAME = "SnowFlake Warehouse";
    private static final String DESCRIPTION = "Connector for accessing SnowFlake Warehouse through JDBC.";
    private static final String LONG_DESCRIPTION = "This connector uses the Java Database Connectivity (JDBC) snowflake jdbc driver version 3.6.16 to "
    ...
    public SnowFlakeJDBCConnector() {
        super();
    }

    private SnowFlakeJDBCConnector(PluginConfig config, PluginCallback callback)
    ...
    public ConnectorPlugin build(PluginConfig config, PluginCallback pluginCallback)
            throws ConfigurationException {
        return new SnowFlakeJDBCConnector(config, pluginCallback);
    }
