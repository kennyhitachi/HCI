...
public class CountMetadataFieldNameMatchStage implements StagePlugin {

    private static final String PLUGIN_NAME = "com.hitachi.hci.plugins.stage.custom.countMetadataFieldNameMatchStage";
    private static final String NAME = "Count Field Name";
    private static final String DESCRIPTION = "Find the metadata field name that matches and return the matches count";
    ...
    public static final ConfigProperty.Builder REGEX_MATCH_PROPERTY = new ConfigProperty.Builder()
            .setName("hci.plugins.stage.custom.countMetadataFieldNameMatch.regexMatch")
            .setValue("")
    ...
    public static final ConfigProperty.Builder COUNT_FIELD_NAME_PROPERTY = new ConfigProperty.Builder()
            .setName("hci.plugins.stage.custom.countMetadataFieldNameMatch.countResult")
            .setValue("FieldNameMatchCountResult")
            .setType(PropertyType.TEXT)
            .setRequired(true)
    ...
    public CountMetadataFieldNameMatchStage() {
        config = null;
        callback = null;
    }

    // Constructor for configured plugin instances to be used in workflows
    private CountMetadataFieldNameMatchStage(PluginConfig config, PluginCallback callback)
    ...
    @Override
    public CountMetadataFieldNameMatchStage build(PluginConfig config, PluginCallback callback)
            throws ConfigurationException {
        // This method is used as a factory to create a configured instance of this stage
        return new CountMetadataFieldNameMatchStage(config, callback);
    }
    ...
    public Iterator<Document> process(PluginSession session, Document inputDocument) {
        ...
        int matchResultCount = CountMatches.countMatches(metadataNamesString, regExString);
