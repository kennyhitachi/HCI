...
public class AlgomiRawGenerator  extends BaseMetadataGenerator {
	 ...
	 */
	private class AlgomiRawGeneratorProperties extends BaseGeneratorProperties {
		public AlgomiRawGeneratorProperties() {
			super();
		}
	...
	AlgomiRawGeneratorProperties mProps = new AlgomiRawGeneratorProperties();
	...
	public LinkedList<ObjectContainer> getMetadataList(BaseWorkItem inItem) {
		...
		String combinedDirName = inSrcFile.getParentFile().getParentFile().getName()+"-"+parentFolder.getName();
